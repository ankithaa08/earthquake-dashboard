...
# Wide layout for better presentation
st.set_page_config(
...
fig, ax = plt.subplots(figsize=(10, 4))  # good for presentation
...
fig_b, axes = plt.subplots(1, 2, figsize=(12, 4))
...
fig_hb, ax_hb = plt.subplots(figsize=(8, 5))
