...
fig, ax = plt.subplots(figsize=(8, 3))  # smaller plot
...
fig_b, axes = plt.subplots(1, 2, figsize=(10, 3))  # smaller
...
fig_hb, ax_hb = plt.subplots(figsize=(6.5, 4))
...
fig_ct, ax_ct = plt.subplots(figsize=(6.5, 4))
